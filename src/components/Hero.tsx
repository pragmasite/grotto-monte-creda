    ...
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="container relative mx-auto flex min-h-screen flex-col items-center justify-center px-4 text-center">
        ...
        <motion.h1
          ...
          className="mb-6 max-w-4xl font-serif text-4xl text-white md:text-6xl lg:text-7xl"
        >
          {t.hero.title1}
          <br />
        ...
        <motion.a
          ...
          className="absolute bottom-8 rounded-full border border-white/30 p-3 text-white/70 hover:bg-white/10 transition-colors"
        >
